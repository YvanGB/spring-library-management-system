...
import com.esmt.lms.repository.IssueRepository;
...
public class IssueService {
	...
	public Issue addNew(Issue issue) {
		...
		issue.setMember(issue.getMember());
		issue.setExpectedReturnDate(issue.getExpectedReturnDate());
		issue.setIssuedBooks(issue.getIssuedBooks());
